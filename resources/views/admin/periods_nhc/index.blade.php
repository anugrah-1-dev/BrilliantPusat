                ...
                <form action="{{ route('admin.periods_nhc.store') }}" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="create_start_date">Tanggal Mulai</label>
                            <input type="date" id="create_start_date" name="start_date" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label for="create_end_date">Tanggal Selesai</label>
                            <input type="date" id="create_end_date" name="end_date" class="form-control" required>
                        </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ route('admin.periods_nhc.update', $p->id) }}" method="POST">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <label for="edit_start_date_{{ $p->id }}">Tanggal Mulai</label>
                                <input type="date" id="edit_start_date_{{ $p->id }}" name="start_date" value="{{ $p->start_date->format('Y-m-d') }}"
                                    class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label for="edit_end_date_{{ $p->id }}">Tanggal Selesai</label>
                                <input type="date" id="edit_end_date_{{ $p->id }}" name="end_date" value="{{ $p->end_date->format('Y-m-d') }}"
                                    class="form-control" required>
                            </div>
                            <div class="form-check">
